    ...
    <section id="features">
      <div className="container flex flex-col px-4 mx-auto mt-10 space-y-12 md:space-y-0 md:flex-row">
        <div className="flex flex-col space-y-12 md:w-1/2">
          <h2 className="max-w-md text-4xl font-bold text-center md:text-left">What is different about Manage?</h2>
        ...
        <div className="flex flex-col space-y-8 md:w-1/2">
          <div className="flex flex-col space-y-3 md:space-y-0 md:space-x-6 md:flex-row">
            <div className="rounded-l-full bg-brightRedVeryLight md:bg-transparent">
            ...
            <div>
              <h3 className="md:block hidden text-xl font-bold mb-4">Track company-wide progress</h3>
          ...
          <div className="flex flex-col space-y-3 md:space-y-0 md:space-x-6 md:flex-row">
            ...
            <div>
              <h3 className="md:block hidden text-xl font-bold mb-4">Advanced built-in reports</h3>
              <p className="text-darkGrayishBlue">
          ...
          <div className="flex flex-col space-y-3 md:space-y-0 md:space-x-6 md:flex-row">
            ...
            <div>
              <h3 className="md:block hidden text-xl font-bold mb-4">Everything you need in one place</h3>
              <p className="text-darkGrayishBlue">
